...
{
	public class OpenSortedDictionary : OpenSet
	{
		private readonly SortedDictionary<Vector3i, PathNode> m_OpenDictionary = new SortedDictionary<Vector3i, PathNode>();

		public override Boolean Any() => m_OpenDictionary.Any();

		public OpenSortedDictionary() => Structure = "SortedDictionary";
